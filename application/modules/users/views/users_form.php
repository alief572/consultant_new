	...
	<div class="box-body">
		...
		<div class="form-group">
			...
			<div class='col-sm-3'>
				...
				echo form_dropdown('department_id', $departmentx, $deptid, array('id' => 'department_id', 'class' => 'form-control select_department input-md', 'required' => 'required'));
				?>
			</div>
		</div>
		<div class="form-group">
			...
			<div class='col-sm-3'>
				<select name="employee_id" class="form-control select_employee">
					<option value="">Select Employee</option>
					<?php
					foreach ($employee as $item) {
						$selected = '';
						if (isset($data) && $data->employee_id == $item->id) {
							$selected = 'selected';
						}
