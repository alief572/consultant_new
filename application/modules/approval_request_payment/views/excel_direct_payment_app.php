...
header("Content-Disposition: attachment; filename=Approval Request Payment Payment (" . $nama_tingkat . ").xls");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Export Excel Direct Payment Finance</title>
</head>
...
<body>
    <table class="table table-bordered" border="1">
        <thead>
            <tr>
                <th align="center">No. Direct Payment</th>
