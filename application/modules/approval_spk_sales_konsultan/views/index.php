<?php
$ENABLE_ADD     = has_permission('Sales_&_Konsultan.Add');
$ENABLE_MANAGE  = has_permission('Sales_&_Konsultan.Manage');
$ENABLE_VIEW    = has_permission('Sales_&_Konsultan.View');
$ENABLE_DELETE  = has_permission('Sales_&_Konsultan.Delete');
?>
