        ...
        <div class="box-body">
            <table class="table custom-table">
                ...
                <tbody>
                    ...
                    foreach ($list_others_custom as $item) {
                        $no++;

                        $qty_terpakai = (isset($data_kasbon_others[$item->id]['ttl_qty_pengajuan'])) ? $data_kasbon_others[$item->id]['ttl_qty_pengajuan'] : 0;
                        $total_terpakai = (isset($data_kasbon_others[$item->id]['ttl_qty_pengajuan'])) ? $data_kasbon_others[$item->id]['ttl_total_pengajuan'] : 0;
                        ...
                        echo '<input type="hidden" name="detail_others[' . $no . '][total_estimasi]" value="' . $item->estimasi_total . '">';
                        echo '</td>';
                        ...
                        echo '<input type="hidden" name="detail_others[' . $no . '][price_unit_terpakai]" value="' . $item->estimasi_harga . '">';
                        echo '</td>';
                        ...
                        echo '<input type="hidden" name="detail_others[' . $no . '][nominal_overbudget]" value="' . $item->estimasi_harga . '">';
                        echo '</td>';
            ...
            <table class="table custom-table">
                ...
                <tbody>
                    ...
                    foreach ($list_others as $item) {
                        ...
                        echo '<td>';
                        echo '<input type="text" name="detail_others[' . $no . '][nominal_pengajuan]" class="form-control form-control-sm text-right auto_num" onchange="hitung_all_pengajuan()" data-no="' . $no . '" data-budget="' . $item->price_unit_final . '" value="' . $item->price_unit_final . '" ' . $readonly . '>';
                        echo '</td>';
                    ...
                    foreach ($list_others_custom as $item) {
                        ...
                        echo '<td>';
                        echo '<input type="text" name="detail_others[' . $no . '][total_pengajuan]" class="form-control form-control-sm text-right auto_num" onchange="hitung_all_pengajuan()" value="" readonly>';
                        echo '<input type="hidden" name="detail_others[' . $no . '][aktual_terpakai]" value="' . ($item->estimasi_qty - $aktual_terpakai + $qty_tambahan) . '">';
                        echo '<input type="hidden" name="detail_others[' . $no . '][sisa_budget]" value="' . ($sisa_budget + ($qty_tambahan * $nominal_tambahan)) . '">';
                        echo '</td>';
