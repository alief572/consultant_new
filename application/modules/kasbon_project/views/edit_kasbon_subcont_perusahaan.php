                ...
                <tbody>
                    ...
                    foreach ($list_data_subcont_perusahaan as $item) {
                        if (isset($list_arr_kasbon[$item->id_subcont])) {
                            ...
                            echo '<td>';
                            echo '<input type="text" name="detail_subcont_perusahaan[' . $no . '][nominal_pengajuan]" class="form-control form-control-sm text-right auto_num hitung_per_price" data-no="' . $no . '" data-budget="' . $item->price_unit_final . '" value="' . $nominal_pengajuan . '" ' . $readonly . '>';
                            echo '</td>';
