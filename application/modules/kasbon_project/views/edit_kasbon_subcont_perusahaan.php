            ...
            <table class="table custom-table">
                ...
                <tbody>
                    ...
                    foreach ($list_data_subcont_perusahaan as $item) {
                        ...
                        echo '<input type="hidden" name="detail_subcont_perusahaan[' . $no . '][nm_item]" value="' . (!empty($item->nm_biaya) ? $item->nm_biaya : $item->nm_item) . '">';
                        echo '</td>';
                        ...
                        echo '<input type="hidden" name="detail_subcont_perusahaan[' . $no . '][total_budget_estimasi]" value="' . $item->total_final . '">';
                        echo '</td>';
                        ...
                        echo '<input type="hidden" name="detail_subcont_perusahaan[' . $no . '][nominal_terpakai]" value="' . $nominal_terpakai . '">';
                        echo '</td>';
                        ...
                        echo '<input type="hidden" name="detail_subcont_perusahaan[' . $no . '][qty_overbudget]" value="' . $qty_overbudget . '">';
                        echo '</td>';

                        echo '<td class="text-right">';
                        echo ($qty_overbudget > 0) ? number_format($nominal_overbudget, 2) : '-';
                        echo '<input type="hidden" name="detail_subcont_perusahaan[' . $no . '][nominal_overbudget]" value="' . $nominal_overbudget . '">';
                        echo '</td>';

                        echo '<td class="text-right">';
                        echo ($qty_overbudget > 0) ? number_format($total_overbudget, 2) : '-';
                        echo '<input type="hidden" name="detail_subcont_perusahaan[' . $no . '][total_overbudget]" value="' . $total_overbudget . '">';
                        echo '<input type="hidden" name="detail_subcont_perusahaan[' . $no . '][sisa_budget]" value="' . $sisa_budget . '">';
                        echo '<input type="hidden" name="detail_subcont_perusahaan[' . $no . '][aktual_terpakai]" value="' . $aktual_terpakai . '">';
                        echo '</td>';
                    ...
                    foreach ($list_data_subcont_perusahaan_custom as $item) {
                        ...
                        echo '<input type="hidden" name="detail_subcont_perusahaan[' . $no . '][total_budget_estimasi]" value="' . $item->estimasi_total . '">';
                        echo '</td>';
                ...
                <tbody>
                    ...
                    foreach ($list_data_subcont_perusahaan as $item) {
                        if (isset($list_arr_kasbon[$item->id_subcont])) {
                            ...
                            echo '<td>';
                            echo '<input type="number" name="detail_subcont_perusahaan[' . $no . '][qty_pengajuan]" class="form-control form-control-sm text-right" onchange="hitung_all_pengajuan()" step="0.01" value="' . $qty_pengajuan . '" ' . $readonly . '>';
                            echo '</td>';

                            echo '<td>';
                            echo '<input type="text" name="detail_subcont_perusahaan[' . $no . '][nominal_pengajuan]" class="form-control form-control-sm text-right auto_num" onchange="hitung_all_pengajuan()" data-no="' . $no . '" data-budget="' . $item->price_unit_final . '" value="' . $nominal_pengajuan . '" ' . $readonly . '>';
                            echo '</td>';

                            echo '<td>';
                            echo '<input type="text" name="detail_subcont_perusahaan[' . $no . '][total_pengajuan]" class="form-control form-control-sm text-right auto_num" onchange="hitung_all_pengajuan()" value="' . $total_pengajuan . '" readonly>';
                            echo '</td>';
                    ...
                    foreach ($list_data_subcont_perusahaan_custom as $item) {
                        if (isset($list_arr_kasbon[$item->id])) {
                            ...
                            echo '<td>';
                            echo '<input type="text" name="detail_subcont_perusahaan[' . $no . '][nominal_pengajuan]" class="form-control form-control-sm text-right auto_num hitung_per_price" data-no="' . $no . '" data-budget="' . $item->estimasi_harga . '" value="' . $nominal_pengajuan . '" ' . $readonly . '>';
                            echo '</td>';
...
<script>
    ...
    $(document).on('submit', '#frm-data', function(e) {
        ...
        if (ttl_propose <= 0) {
            errors.push({ name: 'Item Pengajuan (minimal 1 item harus diajukan dengan nominal > 0)', el: $('input[name="detail_subcont_perusahaan[1][qty_pengajuan]"]') });
            $('input[name="detail_subcont_perusahaan[1][qty_pengajuan]"]').addClass('input-error');
        }
        ...
        if (valid == '0') {
            ...
            if (res.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: siteurl + active_controller + 'update_kasbon_subcont_perusahaan',
                        data: formData,
                        cache: false,
                        processData: false,
                        contentType: false,
