        ...
        <div class="box-body">
            <table class="table custom-table">
                ...
                <tbody>
                    ...
                    foreach ($list_data_subcont_tenaga_ahli as $item) {
                        $no++;

                        $qty_pengajuan = (isset($list_arr_kasbon[$item->id_subcont])) ? $list_arr_kasbon[$item->id_subcont]['qty_pengajuan'] : 0;
                        $nominal_pengajuan = (isset($list_arr_kasbon[$item->id_subcont])) ? $list_arr_kasbon[$item->id_subcont]['nominal_pengajuan'] : 0;
                        $total_pengajuan = (isset($list_arr_kasbon[$item->id_subcont])) ? $list_arr_kasbon[$item->id_subcont]['total_pengajuan'] : 0;
                        $aktual_terpakai = (isset($list_arr_kasbon[$item->id_subcont])) ? $list_arr_kasbon[$item->id_subcont]['aktual_terpakai'] : 0;
                        if ($aktual_terpakai <= 0) {
                            $aktual_terpakai = $item->qty_final;
                        }
                        $sisa_budget = (isset($list_arr_kasbon[$item->id_subcont])) ? $list_arr_kasbon[$item->id_subcont]['sisa_budget'] : 0;
                        if ($sisa_budget <= 0) {
                        ...
                        echo $no;
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][id_subcont]" value="' . $item->id_subcont . '">';
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][id_item]" value="' . $item->id_item . '">';
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][nm_item]" value="' . (!empty($item->nm_biaya) ? $item->nm_biaya : $item->nm_item) . '">';
                        echo '</td>';
                        ...
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][qty_estimasi]" value="' . $item->qty_final . '">';
                        echo '</td>';

                        echo '<td class="text-right">';
                        echo number_format($item->price_unit_final, 2);
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][price_unit_estimasi]" value="' . $item->price_unit_final . '">';
                        echo '</td>';

                        echo '<td class="text-right">';
                        echo number_format($item->total_final, 2);
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][total_budget_estimasi]" value="' . $item->total_final . '">';
                        echo '</td>';

                        echo '<td class="text-center">';
                        echo number_format($qty_terpakai);
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][qty_terpakai]" value="' . $qty_terpakai . '">';
                        echo '</td>';

                        echo '<td class="text-right">';
                        echo ($qty_terpakai > 0) ? number_format($nominal_terpakai, 2) : '-';
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][nominal_terpakai]" value="' . $nominal_terpakai . '">';
                        echo '</td>';

                        echo '<td class="text-right">';
                        echo ($qty_terpakai > 0) ? number_format($total_terpakai, 2) : '-';
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][total_terpakai]" value="' . $total_terpakai . '">';
                        echo '</td>';

                        echo '<td class="text-center">';
                        echo number_format($qty_overbudget);
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][qty_overbudget]" value="' . $qty_overbudget . '">';
                        echo '</td>';

                        echo '<td class="text-right">';
                        echo ($qty_overbudget > 0) ? number_format($nominal_overbudget, 2) : '-';
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][nominal_overbudget]" value="' . $nominal_overbudget . '">';
                        echo '</td>';

                        echo '<td class="text-right">';
                        echo ($qty_overbudget > 0) ? number_format($total_overbudget, 2) : '-';
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][total_overbudget]" value="' . $total_overbudget . '">';
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][sisa_budget]" value="' . $sisa_budget . '">';
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][aktual_terpakai]" value="' . $aktual_terpakai . '">';
                        echo '</td>';
                    ...
                    foreach ($list_data_subcont_tenaga_ahli_custom as $item) {
                        $no++;
                        ...
                        echo '<td class="text-center">';
                        echo $no;
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][id_subcont]" value="' . $item->id . '">';
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][id_item]" value="' . $item->id . '">';
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][nm_item]" value="' . $item->nm_item . '">';
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][custom_subcont_tenaga_ahli]" value="1">';
                        echo '</td>';
                        ...
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][qty_estimasi]" value="' . $item->estimasi_qty . '">';
                        echo '</td>';

                        echo '<td class="text-right">';
                        echo number_format($item->estimasi_harga, 2);
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][price_unit_estimasi]" value="' . $item->estimasi_harga . '">';
                        echo '</td>';

                        echo '<td class="text-right">';
                        echo number_format($item->estimasi_total, 2);
                        echo '<input type="hidden" name="detail_subcont_tenaga_ahli[' . $no . '][total_budget_estimasi]" value="' . $item->estimasi_total . '">';
                        echo '</td>';
                ...
                <tbody>
                    ...
                    foreach ($list_data_subcont_tenaga_ahli as $item) {
                        if (isset($list_arr_kasbon[$item->id_subcont])) {
                            ...
                            $pengajuan_budget = (isset($data_overbudget_subcont_tenaga_ahli[$item->id_subcont])) ? $data_overbudget_subcont_tenaga_ahli[$item->id_subcont]['pengajuan_budget'] : 0;

                            $aktual_terpakai = (isset($data_kasbon_subcont_tenaga_ahli[$item->id_subcont]['ttl_qty_pengajuan'])) ? $data_kasbon_subcont_tenaga_ahli[$item->id_subcont]['ttl_qty_pengajuan'] : 0;
                            $sisa_budget = (isset($data_kasbon_subcont_tenaga_ahli[$item->id_subcont]['ttl_total_pengajuan'])) ? (($item->price_unit_final * $item->qty_final) - $data_kasbon_subcont_tenaga_ahli[$item->id_subcont]['ttl_total_pengajuan']) : ($item->price_unit_final * $item->qty_final);
                            ...
                            $qty_pengajuan = (isset($list_arr_kasbon[$item->id_subcont]['qty_pengajuan'])) ? $list_arr_kasbon[$item->id_subcont]['qty_pengajuan'] : '0';
                            $nominal_pengajuan = (isset($list_arr_kasbon[$item->id_subcont]['nominal_pengajuan'])) ? $list_arr_kasbon[$item->id_subcont]['nominal_pengajuan'] : '0';
                            $total_pengajuan = (isset($list_arr_kasbon[$item->id_subcont]['total_pengajuan'])) ? $list_arr_kasbon[$item->id_subcont]['total_pengajuan'] : '0';
                            ...
                            echo '<td>';
                            echo '<input type="number" name="detail_subcont_tenaga_ahli[' . $no . '][qty_pengajuan]" class="form-control form-control-sm text-right" onchange="hitung_all_pengajuan()" step="0.01" value="' . $qty_pengajuan . '" ' . $readonly . '>';
                            echo '</td>';

                            echo '<td>';
                            echo '<input type="text" name="detail_subcont_tenaga_ahli[' . $no . '][nominal_pengajuan]" class="form-control form-control-sm text-right auto_num" onchange="hitung_all_pengajuan()" data-no="' . $no . '" data-budget="' . $item->price_unit_final . '" value="' . $nominal_pengajuan . '" ' . $readonly . '>';
                            echo '</td>';

                            echo '<td>';
                            echo '<input type="text" name="detail_subcont_tenaga_ahli[' . $no . '][total_pengajuan]" class="form-control form-control-sm text-right auto_num" onchange="hitung_all_pengajuan()" value="' . $total_pengajuan . '" readonly>';
                            echo '</td>';
                    ...
                    foreach ($list_data_subcont_tenaga_ahli_custom as $item) {
                        if (isset($list_arr_kasbon[$item->id])) {
                            ...
                            $qty_tambahan = (isset($data_overbudget_subcont_tenaga_ahli[$item->id])) ? $data_overbudget_subcont_tenaga_ahli[$item->id]['qty_budget_tambahan'] : 0;
                            $nominal_tambahan = (isset($data_overbudget_subcont_tenaga_ahli[$item->id])) ? $data_overbudget_subcont_tenaga_ahli[$item->id]['budget_tambahan'] : 0;
                            $pengajuan_budget = (isset($data_overbudget_subcont_tenaga_ahli[$item->id])) ? $data_overbudget_subcont_tenaga_ahli[$item->id]['pengajuan_budget'] : 0;

                            $aktual_terpakai = (isset($data_kasbon_subcont_tenaga_ahli[$item->id]['ttl_qty_pengajuan'])) ? $data_kasbon_subcont_tenaga_ahli[$item->id]['ttl_qty_pengajuan'] : 0;
                            $sisa_budget = (isset($data_kasbon_subcont_tenaga_ahli[$item->id]['ttl_total_pengajuan'])) ? (($item->estimasi_harga * $item->estimasi_qty) - $data_kasbon_subcont_tenaga_ahli[$item->id]['ttl_total_pengajuan']) : ($item->estimasi_harga * $item->estimasi_qty);
                            ...
                            echo '<td>';
                            echo '<input type="text" name="detail_subcont_tenaga_ahli[' . $no . '][nominal_pengajuan]" class="form-control form-control-sm text-right auto_num hitung_per_price" data-no="' . $no . '" data-budget="' . $item->estimasi_harga . '" value="' . $nominal_pengajuan . '" ' . $readonly . '>';
                            echo '</td>';
...
<script>
    ...
    function hitung_all_pengajuan() {
        ...
        for (i = 1; i <= no; i++) {
            var qty_pengajuan = $('input[name="detail_subcont_tenaga_ahli[' + i + '][qty_pengajuan]"]').val();
            ...
            var nominal_pengajuan = get_num($('input[name="detail_subcont_tenaga_ahli[' + i + '][nominal_pengajuan]"]').val());
            // if (qty_pengajuan < 1) {
            //     var total_pengajuan = get_num($('input[name="detail_subcont_tenaga_ahli[' + i + '][total_pengajuan]"]').val());
            // } else {
            var total_pengajuan = (nominal_pengajuan * qty_pengajuan);
            // }

            $('input[name="detail_subcont_tenaga_ahli[' + i + '][total_pengajuan]"]').autoNumeric('set', total_pengajuan);
    ...
    $(document).on('change', '.hitung_per_price', function() {
        ...
        $('input[name="detail_subcont_tenaga_ahli[' + no + '][qty_pengajuan]"]').val(qty.toFixed(2));
        $('input[name="detail_subcont_tenaga_ahli[' + no + '][total_pengajuan]"]').autoNumeric('set', pengajuan);
    ...
    $(document).on('submit', '#frm-data', function(e) {
        ...
        for (i = 1; i <= no; i++) {
            var qty_pengajuan = get_num($('input[name="detail_subcont_tenaga_ahli[' + i + '][qty_pengajuan]"]').val());
            var nominal_pengajuan = get_num($('input[name="detail_subcont_tenaga_ahli[' + i + '][nominal_pengajuan]"]').val());
        ...
        if (ttl_propose <= 0) {
            errors.push({ name: 'Item Pengajuan (minimal 1 item harus diajukan dengan nominal > 0)', el: $('input[name="detail_subcont_tenaga_ahli[1][qty_pengajuan]"]') });
            $('input[name="detail_subcont_tenaga_ahli[1][qty_pengajuan]"]').addClass('input-error');
        }
        ...
        //     var qty_pengajuan = get_num($('input[name="detail_subcont_tenaga_ahli[' + i + '][qty_pengajuan]"]').val());
        //     var nominal_pengajuan = get_num($('input[name="detail_subcont_tenaga_ahli[' + i + '][nominal_pengajuan]"]').val());
        //     var sisa_budget = get_num($('input[name="detail_subcont_tenaga_ahli[' + i + '][sisa_budget]"]').val());
        ...
        if (valid == '0') {
            ...
            if (res.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: siteurl + active_controller + 'update_kasbon_subcont_tenaga_ahli',
                        data: formData,
                        cache: false,
                        processData: false,
                        contentType: false,
