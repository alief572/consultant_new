                ...
                <tbody>
                    ...
                    foreach ($list_data_lab as $item) {
                        if (isset($list_arr_kasbon[$item->id_lab])) {
                            ...
                            echo '</td>';
                            echo '<td class="text-center">';
                            echo '<input type="number" name="detail_lab[' . $no . '][qty_pengajuan]" class="form-control form-control-sm text-center" value="' . $qty_pengajuan . '" step="0.01" onchange="hitung_all_pengajuan();">';
                            echo '</td>';
                            echo '<td class="text-right">';
                            echo '<input type="text" name="detail_lab[' . $no . '][nominal_pengajuan]" class="form-control form-control-sm text-right auto_num hitung_per_price" value="' . $nominal_pengajuan . '"  data-no="' . $no . '" data-budget="' . $item->price_unit_final . '">';
                            echo '</td>';
                            echo '<td class="text-right">';
                            echo '<input type="text" name="detail_lab[' . $no . '][total_pengajuan]" class="form-control form-control-sm text-right auto_num" value="' . $total_pengajuan . '" readonly>';
                            echo '</td>';
                            echo '<td class="text-center">';
