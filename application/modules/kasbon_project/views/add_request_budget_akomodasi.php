...
<script>
    ...
    function add_custom_item() {
        no++;
        var html = '<tr class="custom_akomodasi_' + no + '">';

        html += '<td class="text-center">' + no + '</td>';

        html += '<td>';
        html += '<input type="hidden" name="req_akomodasi[' + no + '][id_detail]" value="">';
        html += '<input type="hidden" name="req_akomodasi[' + no + '][id_item]" value="">';
        html += '<textarea class="form-control form-control-sm" name="req_akomodasi[' + no + '][nm_item]"></textarea>';
        html += '</td>';

        html += '<input type="hidden" name="req_akomodasi[' + no + '][qty_estimasi]" value="0">';
        html += '<input type="hidden" name="req_akomodasi[' + no + '][price_unit_estimasi]" value="0">';
        html += '<input type="hidden" name="req_akomodasi[' + no + '][total_budget]" value="0">';

        html += '<td>';
        html += '<input type="number" class="form-control form-control-sm text-right" name="req_akomodasi[' + no + '][qty_budget_tambahan]" min="0" value="0" onchange="hitung_all()">';
        html += '</td>';

        html += '<td>';
        html += '<input type="text" class="form-control form-control-sm text-right auto_num" name="req_akomodasi[' + no + '][budget_tambahan]" onchange="hitung_all()">';
        html += '</td>';

        html += '<td>';
        html += '<input type="text" class="form-control form-control-sm text-right" name="req_akomodasi[' + no + '][total_new_budget]" readonly>';
        html += '</td>';

        html += '<td>';
        html += '<input type="text" class="form-control form-control-sm text-right" name="req_akomodasi[' + no + '][pengajuan_new_budget]" readonly>';
        html += '</td>';

        html += '<td>';
        html += '<textarea class="form-control form-control-sm" name="req_akomodasi[' + no + '][reason]"></textarea>';
        html += '</td>';
