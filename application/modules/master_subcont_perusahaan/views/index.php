...
<div class="card-modern">
    <div class="card-header-modern">
        <div class="card-title-modern">
            <span class="card-title-icon"><i class="fa fa-building"></i></span>
            <span>Master Subcont Perusahaan</span>
        </div>
        <?php if ($ENABLE_ADD) : ?>
            <div>
                <button type="button" class="btn-modern-add add">
                    <i class="fa fa-plus-circle"></i> Tambah Subcont
                </button>
            </div>
        <?php endif; ?>
    </div>
        ...
        <div class="modal-content modal-content-modern">
            <div class="modal-header modal-header-modern">
                ...
                <h4 class="modal-title" id="head_title">
                    <i class="fa fa-building"></i> <span id="modal-title-text">Data Subcont Perusahaan</span>
                </h4>
            </div>
...
<script type="text/javascript">
    ...
    function datatables() {
        dataTable = $('#example1').DataTable({
            ...
            "oLanguage": {
                ...
                "sEmptyTable": "<div class='text-center text-muted' style='padding: 20px;'><i class='fa fa-folder-open-o fa-2x'></i><br><br>Belum ada data subcont perusahaan</div>",
    ...
    $(document).on('click', '.add', function(e) {
        e.preventDefault();
        $('#modal-title-text').html('Tambah Subcont Perusahaan');
    ...
    $(document).on('click', '.view_biaya_modal', function(e) {
        e.preventDefault();
        var id = $(this).data('id');
        $('#modal-title-text').html('Detail Subcont Perusahaan');
        ...
        $.ajax({
            ...
            error: function() {
                Swal.fire({
                    icon: 'error',
                    title: 'Error!',
                    text: 'Gagal memuat detail subcont perusahaan. Silakan coba lagi!'
                });
            }
        });
    });
    ...
    $(document).on('click', '.edit_biaya_modal', function(e) {
        e.preventDefault();
        var id = $(this).data('id');
        $('#modal-title-text').html('Edit Subcont Perusahaan');
    ...
    $(document).on('submit', '#frm-data', function(e) {
        ...
        if ($.trim(nm_biaya) === '') {
            Swal.fire({
                icon: 'warning',
                title: 'Perhatian!',
                text: 'Nama Subcont Perusahaan wajib diisi!'
            });
            return false;
        }
    ...
    $(document).on('click', '.del_biaya', function(e) {
        ...
        Swal.fire({
            ...
            text: 'Data subcont perusahaan ini akan dihapus!',
            icon: 'warning',
            showCancelButton: true,
