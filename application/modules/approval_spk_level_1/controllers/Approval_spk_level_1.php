...
$status = array();
class Approval_spk_level_1 extends Admin_Controller
{
    //Permission
    protected $viewPermission     = 'Approval_SPK_Level_1.View';
    protected $addPermission      = 'Approval_SPK_Level_1.Add';
    protected $managePermission = 'Approval_SPK_Level_1.Manage';
    protected $deletePermission = 'Approval_SPK_Level_1.Delete';
    ...
    public function get_data_spk()
    {
        ...
        foreach ($get_data->result() as $item) {
            ...
            if ($this->managePermission) {
                ...
                if ($get_user->employee_id == $item->id_project_leader && $item->approval_project_leader_sts == 1) {
                    $valid = 0;
                }
