...
<div class="card-modern">
    <div class="card-header-modern">
        <div class="card-title-modern">
            <span class="card-title-icon"><i class="fa fa-money"></i></span>
            <span>Master Data Biaya</span>
        </div>
        <?php if ($ENABLE_ADD) : ?>
            <div>
                <button type="button" class="btn-modern-add add">
                    <i class="fa fa-plus-circle"></i> Tambah Data Biaya
                </button>
            </div>
        <?php endif; ?>
    </div>
            ...
            <table id="example1" class="table table-bordered table-modern" width="100%">
                <thead>
                    <tr>
                        ...
                        <th>Nama Biaya</th>
                        <th width="140" style="text-align: center;">Tipe Biaya</th>
                        <th width="220">COA</th>
        ...
        <div class="modal-content modal-content-modern">
            <div class="modal-header modal-header-modern">
                ...
                <h4 class="modal-title" id="head_title">
                    <i class="fa fa-money"></i> <span id="modal-title-text">Data Biaya</span>
                </h4>
            </div>
...
<script type="text/javascript">
    ...
    function datatables() {
        dataTable = $('#example1').DataTable({
            ...
            "oLanguage": {
                ...
                "sEmptyTable": "<div class='text-center text-muted' style='padding: 20px;'><i class='fa fa-folder-open-o fa-2x'></i><br><br>Belum ada data master biaya</div>",
            ...
            "ajax": {
                ...
                dataType: "JSON",
                error: function() {
                    $("#example1").append('<tbody class="grid-error"><tr><th colspan="5" class="text-center text-danger" style="padding: 20px;">Terjadi kesalahan saat memuat data dari server</th></tr></tbody>');
                }
            },
            "columns": [
                { data: 'no' },
    ...
    $(document).on('click', '.add', function(e) {
        e.preventDefault();
        $('#modal-title-text').html('Tambah Data Biaya');
    ...
    $(document).on('click', '.view_biaya_modal', function(e) {
        e.preventDefault();
        var id = $(this).data('id');
        $('#modal-title-text').html('Detail Data Biaya');
        ...
        $.ajax({
            ...
            error: function() {
                Swal.fire({
                    icon: 'error',
                    title: 'Error!',
                    text: 'Gagal memuat detail biaya. Silakan coba lagi!'
                });
            }
        });
    });
    ...
    $(document).on('click', '.edit_biaya_modal', function(e) {
        e.preventDefault();
        var id = $(this).data('id');
        $('#modal-title-text').html('Edit Data Biaya');
    ...
    $(document).on('submit', '#frm-data', function(e) {
        ...
        var tipe_biaya = $('select[name="tipe_biaya"]').val();
    ...
    $(document).on('click', '.del_biaya', function(e) {
        ...
        Swal.fire({
            ...
            text: 'Data master biaya ini akan dihapus!',
            icon: 'warning',
            showCancelButton: true,
