...
<div class="row">
    <div class="col-md-12">
        <div class="form-section-title">
            <i class="fa fa-info-circle"></i> Informasi Data Biaya
        </div>
    </div>

    <div class="col-md-8">
        <div class="form-group-modern">
            <label for="nm_biaya">Nama Biaya <span style="color: #ef4444;">*</span></label>
            <input type="text" name="nm_biaya" id="nm_biaya" class="form-control" placeholder="Contoh: Tiket Pesawat, Penginapan, Konsumsi" value="<?= htmlspecialchars($data_biaya->nm_biaya) ?>" required>
        </div>
    </div>

    <div class="col-md-4">
        <div class="form-group-modern">
            <label for="tipe_biaya">Tipe Biaya <span style="color: #ef4444;">*</span></label>
            <select name="tipe_biaya" id="tipe_biaya" class="form-control" required>
