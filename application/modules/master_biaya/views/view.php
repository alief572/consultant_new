...
<div class="modal-detail-card">
    <div>
        <div class="pkg-label"><i class="fa fa-money"></i> Nama Biaya</div>
        <div class="pkg-title"><?= htmlspecialchars($data_biaya->nm_biaya) ?></div>
    </div>
    <div>
        <?php if ($data_biaya->tipe_biaya == 1) : ?>
            <span class="badge" style="background: #e0f2fe; color: #0284c7; font-weight: 700; padding: 8px 14px; border-radius: 8px; font-size: 13px;">
                <i class="fa fa-bed"></i> Akomodasi
            </span>
        <?php else : ?>
            <span class="badge" style="background: #f1f5f9; color: #475569; font-weight: 700; padding: 8px 14px; border-radius: 8px; font-size: 13px;">
                <i class="fa fa-cubes"></i> Others
            </span>
        <?php endif; ?>
    </div>
</div>
