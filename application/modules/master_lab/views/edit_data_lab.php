...
<form action="" id="form-data">
    <input type="hidden" name="id" value="<?= htmlspecialchars($data_lab->id) ?>">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="form-group-modern">
                ...
                <input type="text" name="isu_lingkungan" class="form-control" id="isu_lingkungan" placeholder="Contoh: Udara Ambien, Emisi Sumber Bergerak" value="<?= htmlspecialchars($data_lab->isu_lingkungan) ?>">
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group-modern">
                ...
                <textarea name="peraturan" id="peraturan" class="form-control" rows="3" placeholder="Masukkan dasar hukum / peraturan terkait..."><?= htmlspecialchars($data_lab->peraturan) ?></textarea>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group-modern">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="harga_ssc" id="harga_ssc" class="form-control form-control-addon text-right auto_num" value="<?= number_format($data_lab->harga_ssc, 0, '', ',') ?>" placeholder="0">
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group-modern">
                ...
                <div class="input-group">
                    <span class="input-group-addon input-group-addon-modern">Rp</span>
                    <input type="text" name="harga_lab" id="harga_lab" class="form-control form-control-addon text-right auto_num" value="<?= number_format($data_lab->harga_lab, 0, '', ',') ?>" placeholder="0">
                </div>
            </div>
        </div>
                ...
                <select name="coa" id="coa" class="form-control select2" style="width: 100%;">
                    ...
                    <?php if (!empty($list_coa)) : ?>
                        <?php foreach ($list_coa as $item_coa) : ?>
                            <option value="<?= htmlspecialchars($item_coa->no_perkiraan) ?>" <?= ($item_coa->no_perkiraan == $data_lab->no_coa) ? 'selected' : '' ?>>
