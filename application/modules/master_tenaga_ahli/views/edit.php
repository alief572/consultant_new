...
<div class="row">
    <div class="col-md-12">
        <div class="form-section-title">
            <i class="fa fa-info-circle"></i> Informasi Tenaga Ahli
        </div>
    </div>

    <div class="col-md-12">
        <div class="form-group-modern">
            <label for="nm_biaya">Nama Tenaga Ahli <span style="color: #ef4444;">*</span></label>
            <input type="text" name="nm_biaya" id="nm_biaya" class="form-control" placeholder="Contoh: Ahli Lingkungan, Ahli Geologi, Ahli K3" value="<?= htmlspecialchars($data_biaya->nm_biaya) ?>" required>
        </div>
    </div>
